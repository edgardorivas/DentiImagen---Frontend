        ...
        <div
            ...
            <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded"
                ...
                <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                    ...
                    <li v-if="getmiUsuario.rol != ('Odontologo') && getmiUsuario.rol != ('Secretaria')" class="items-center">
                ...
                <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                    ...
                    <li v-if="getmiUsuario.rol != ('Secretaria') && getmiUsuario.rol != ('Administrador') " class="items-center">
                ...
                <div >
                    ...
                    <ul v-if="getmiUsuario.rol != ('Odontologo') && getmiUsuario.rol != ('Secretaria')" class="md:flex-col md:min-w-full flex flex-col list-none">
                        <li class="items-center">
