			...
			<div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
				<div class="flex justify-center">
					<div class="rounded-t mb-0 px-4 py-3 border-0">
						<h3 v-if="TipoMateriales && TipoMateriales.data"
							class="font-semibold text-xl text-blueGray-700 uppercase">
							Editando Tipo Material <i
								class="text-verdiAnderson font-extrabold">@{{ TipoMateriales.data[0].nombre_tipo_recurso }}</i>
						</h3>
					</div>
				</div>
				<div class="mt-5 pb-5">
					<div v-if="TipoMateriales && TipoMateriales.data">
						<el-form label-position="top" :model="TipoMateriales.data[0]" :rules="rules"  ref="EditarTipoMaterial" label-width="120px" class="demo-ruleForm">
							<div class="flex flex-wrap justify-around">
								...
								<div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
									<label>
										...
										<el-form-item prop="nombre_tipo_recurso">
											<el-input placeholder="Nombres del tipo de material" type="text"
												v-model="TipoMateriales.data[0].nombre_tipo_recurso"></el-input>
										</el-form-item>
								...
								<div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
									<label>
										...
										<el-form-item prop="descripcion_tipo_recurso">
											<el-input placeholder="Descripcion del tipo de material" type="text"
												v-model="TipoMateriales.data[0].descripcion_tipo_recurso"></el-input>
										</el-form-item>
							...
							<div class="flex flex-wrap justify-around">
								<el-popconfirm confirm-button-text='Si, Eliminar' confirm-button-type="danger"
									...
									class="w-full md:w-1/3" @confirm="eliminarTipoMaterial(TipoMateriales.data[0])">
								...
								<button :disabled="loading"
									...
									type="button" v-on:click="modificarTipoMaterial(TipoMateriales.data[0])">Guardar</button>
							</div>
						</el-form>
...
export default {
	...
	methods: {
		async modificarTipoMaterial(payload) {
            this.$refs['EditarTipoMaterial'].validate(async (valid) => {
				if(valid){
					try {
