                  ...
                  <el-form label-position="top" :model="datos" :rules="rules" ref="registroCompra" label-width="120px"
                      ...
                      <div class="flex flex-wrap justify-around">
                          ...
                          <div v-if="proveedores && proveedores.data" class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                              <label>
                                  ...
                                  <el-form-item prop="idProvedor">

                                    <div v-for="item in proveedores.data" :key="item.id_provedor">
                                      <div v-if="item.id_provedor == idProveedor">
                                        <el-input class="w-full" :disabled="true" :placeholder="item.nombre_proveedor"></el-input>
                                      </div>
                                    </div>
                      ...
                      <div v-if="datos.idProvedor">
                          ...
                          <div v-if="proveedorMateriales && proveedorMateriales.data"
                              ...
                              <div class="my-2 ml-96">
                                  <button @click="centerDialogVisible = true"
                                      class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none ml-56 mb-1 ease-linear transition-all duration-150"
                                      type="button">
                                      Agregar Item
                                  </button>
                              </div>
                      ...
                      <div class="flex flex-wrap justify-around">
                          <el-form label-position="top" :model="datosRecurso" :rules="rulesModal"
                              ...
                              <div class="w-full px-2 mb-3 ">
                                  ...
                                  <el-select class="w-full" v-model="datosRecurso.tipoUnidades" placeholder="Unidades de medida">
                                    <el-option
                              ...
                              <div class="w-full px-2 mb-3 py-1" v-if="datosRecurso.tipoUnidades === 'caja' || datosRecurso.tipoUnidades === 'paquete' ">
                                <p class="ml-1">cuantas unidades tiene el paquete/caja</p>
                                <el-form-item >
                                    <el-input placeholder="Cantidad disponible" type="number"
                                        v-model="datosRecurso.unidadesCaja"></el-input>
                                </el-form-item>
                              </div>
                          </el-form>
                      </div>
...
export default {
  ...
  data() {
      return {
          ...
          idProveedor: this.$route.params.IDProveedor,
          datos: {
              idtrabajador: "",
              formaPago: "",
              fechaCompra: "",
              idProvedor: this.$route.params.IDProveedor,
              recurso: [],
              referencia: '',
              montoTotal: "",
          },
          ...
          rules: {
              idtrabajador: [
                  { required: true, message: 'Es necesario seleccionar el trabajador', trigger: 'change' },
              ],
              formaPago: [
  ...
  created() {
      ...
      this.$store.dispatch("obtenerMaterialesProveedor", {
              id: this.$route.params.IDProveedor
          });
  },
  methods: {
      ...
      // async buscarDataInsumo(){
      //   await this.$store.dispatch("obtenerMaterialesProveedor", {
      //         id: this.$route.params.IDProveedor
      //     });
      // }
  },
