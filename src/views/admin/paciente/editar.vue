    ...
    <div class="w-full mb-12 xl:mb-0 px-4">
      <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
        ...
        <div class="mt-5 pb-5">
          ...
          <el-form v-if="paciente" label-position="top" :model="paciente" :rules="rules" ref="editarPaciente"
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-form-item prop="esta_tratamiento">
                    ...
                    <el-input placeholder="Esta en tratamiento" v-model="paciente.esta_tratamiento"></el-input>
                  </el-form-item>
