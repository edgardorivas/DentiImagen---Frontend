        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
          ...
          <div class="mt-5">
              ...
              <el-table :data="pacientes.data" class="w-full">
                <el-table-column fixed prop="nombre_paciente" label="Nombre del paciente" width="190">
                  <template slot-scope="scope">
                    <router-link :to="`#`" class="uppercase text-verdiAnderson">
                ...
                <el-table-column prop="correo_paciente" label="Correo Electronico"></el-table-column>
