        ...
        <div class="mt-10 pb-5">
          <section v-if="paciente" class="flex flex-wrap break-words m-0 py-0 px-5 justify-around">
            <div class="w-full sm:w-full md:w-1/5 mb-3 text-center" v-if="url">
              <img v-if="paciente.url_imagen != null" :src="`http://localhost:3000/paciente/img/${paciente.url_imagen}`"
                class="w-full" alt="">
              <img v-else src="../../../assets/avatar_masculino.svg" class="w-full" alt="">
              <br>

              <el-button class="border-0 mb-2 bg-violet-50 text-violet-700" v-on:click="centerDialogVisibleImagen = true"
                round>Cambiar imagen</el-button>
                          ...
                          <div class="mb-2">
                            <label>
                              ...
                              <el-switch class="ml-3" v-model="afeccion.completado" active-color="#13ce66"
                                active-text="SI" inactive-color="#ff4949" inactive-text="NO"></el-switch>
                            </label>
                          </div>
                          <div class="flex justify-end">
                            <button class="text-red-500 uppercase" @click="eliminarAfeccion(diente.afecciones, index)"> <i
                ...
                <div class="w-11/12 mb-20 text-center">
                  ...
                  <div v-if="historialPaciente">
                    ...
                    <template>
                      ...
                      <el-pagination class="mt-5" @size-change="handleSizeChange" @current-change="handleCurrentChange"
                        :current-page.sync="currentPage" :page-sizes="[3, 6, 9]" :page-size="pageSize"
                        layout=" prev, pager, next" :total="9">
                      </el-pagination>
                  ...
                  <div v-else>
                    <el-alert class="w-1/2 m-auto" title="El paciente no tiene un historial de tratamiendo por el momento"
          ...
          <el-dialog title="Agregar la imagen del paciente" :visible.sync="centerDialogVisibleImagen" width="30%" center>
