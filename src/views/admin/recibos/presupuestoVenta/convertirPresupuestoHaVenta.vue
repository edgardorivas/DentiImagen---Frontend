                        ...
                        <div v-if="active == 1" class="my-10 flex flex-wrap justify-around">
                            ...
                            <div v-if="usuarios && usuarios.data" class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                                <label>
                                    ...
                                    <el-input  type="text" disabled :placeholder="`${presupuesto.data[0].nombre_trabajador} ${presupuesto.data[0].nombre_trabajador}`">
                                    </el-input>
                            ...
                            <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                                ...
                                <label>
                                    ...
                                    <el-input  type="text" disabled :placeholder="`${presupuesto.data[0].nombre_paciente} ${presupuesto.data[0].apellido_paciente}`">
                                    </el-input>
                                </label>
                            </div>
        ...
        pasarValores(){
            ...
            if(this.detallesPresupuesto){
                ...
                this.detallesPresupuesto.data.forEach(servicioPresupuesto => {
                    this.asociarServiciosIngresados({'idServicio' : servicioPresupuesto.id_servicio,cantidadRealizadas: servicioPresupuesto.cantidad})
                })
            }
        }
