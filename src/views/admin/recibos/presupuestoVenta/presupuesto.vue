        ...
        <div class="flex justify-center w-full sm:px-5 md:px-20 lg:px-36">
          <form class="w-full" @submit.prevent="registrarCompra()">
            <div v-if="active == 1" class="my-10 flex flex-wrap justify-around">
              ...
              <div
                v-if="pacientes && pacientes.data"
                class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1"
              >
                <label>
                  <p class="ml-1">Paciente</p>
                  <el-select
                    v-model="datosVenta.idPaciente"
                    placeholder="Paciente"
                    class="w-full"
                  >
                    <el-option
                      v-for="item in pacientes.data"
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  <p class="ml-1">Iva</p>
                  <el-input
                    placeholder="Iva de la venta"
                    type="number"
                    v-model="datosVenta.ivaVenta"
                  ></el-input>
                </label>
              </div>
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-input
                    placeholder="Monto del Dolar Actual en Bs"
                    type="number"
                    min="1"
                    step="any"
                    v-model="datosVenta.precioDolar"
                  ></el-input>
                </label>
              </div>
            </div>
            ...
            <div v-if="active == 2" class="my-10 flex flex-wrap justify-around">
              ...
              <button
                type="button"
                class="md:w-1/5 py-2 text-white bg-verdiAnderson transition duration-500 transform hover:-translate-y-1 hover:scale-100 uppercase rounded-md"
                @click="next"
              >
                Ingresar
              </button>
              ...
              <div
                v-if="serviciosIngresados.length"
                class="w-11/12 mt-10 m-0 p-0"
              >
                <div class="w-11/12">
          ...
          <el-dialog
            title="Agregar los datos de los materiales"
          ...
          >
            ...
            <div
              slot="footer"
              class="dialog-footer flex flex-wrap justify-around"
            >
              <button
                slot="reference"
                :disabled="loading"
...
<script>
  ...
  export default {
    name: 'presupuesto-crear',
    metaInfo: {
      title: config.frontend.title,
      titleTemplate: '%s | Crear Presupuesto',
    },
    created() {
