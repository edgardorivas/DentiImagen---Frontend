              ...
              <div class="flex flex-wrap justify-around">
                ...
                <div v-if="usuarios && usuarios.data" class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    ...
                    <el-select v-model="datos.idtrabajador"  placeholder="Formas de pago" class="w-full">
                      <el-option v-for="item in usuarios.data" :key="item.id" :label="item.nombre" :value="item.id"></el-option>
                    </el-select>
                  </label>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    ...
                    <el-select v-model="datos.formaPago"  placeholder="Formas de pago" class="w-full">
                      <el-option v-for="item in opciones" :key="item.value" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                  </label>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    ...
                    <el-input placeholder="Fecha de la compra" type="date" auto-complete="tel" v-model="datos.fechaCompra"></el-input>
                  </label>
                </div>

                <div v-if="proveedores && proveedores.data"  class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    <p class="ml-1">Poveedor</p>
                    <el-select v-model="datos.idProvedor"  placeholder="Formas de pago" class="w-full">
                      <el-option  v-for="item in proveedores.data" :key="item.id_provedor" :label="item.nombre_proveedor" :value="item.id_provedor"></el-option>
                    </el-select>
                  </label>
                </div>

                <el-divider>Datos del la materia comprada</el-divider>
                
  
<!--no funciona-->
                <div v-if="datos.idProvedor"  class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    <p class="ml-1">Materiales</p>
                    <el-select v-model="datosRecurso.idRecurso"  placeholder="Formas de pago" class="w-full">
                      <el-option v-for="item in proveedorRecurso.data" :key="item.id_recurso" :label="item.nombre_recurso" :value="item.id_recurso"></el-option>
                    </el-select>
                  </label>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    ...
                    <el-input placeholder="Unidades compradas" type="number" auto-complete="email" v-model="datosRecurso.unidades" ></el-input>
                  </label>
                </div>
                <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    <p class="ml-1">Costo en Bolivares</p>
                    <el-input placeholder="Costo en Bolivares" type="number" auto-complete="tel" v-model="datosRecurso.costoB"></el-input>
                  </label>
                </div>
                <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                  <label>
                    <p class="ml-1">Costo en Dolares</p>
                    <el-input placeholder="Costo en Dolares" type="number" v-model="datosRecurso.costoD"></el-input>
                  </label>
                </div>
              ...
              <div class="flex flex-wrap justify-around">
                  <div class="w-full md:w-1/2 lg:w-3/12 px-2 mb-3 py-1 ">
                      <button :disabled="loading" class="w-full md:w-1/3 bg-verdiAnderson text-white transition duration-500 transform hover:-translate-y-1 hover:scale-100 uppercase py-2 rounded-md">agregar  materia </button>
                    </div>
