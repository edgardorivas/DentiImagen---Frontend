            ...
            <div class="flex flex-wrap justify-around">
              ...
              <div v-if="usuarios && usuarios.data" class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-select v-model="datosVenta.idTrabajador" placeholder="Seleccione el Odontologo" class="w-full">
                    <div v-for="item in usuarios.data" :key="item.id">
                      <el-option v-if="item.especializacion == 'Odontologo'" :label="item.nombre" :value="item.id"></el-option>
                    </div>
                  </el-select>
                </label>
              </div>
              <div v-if="pacientes && pacientes.data" class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-select v-model="datosVenta.idPaciente" placeholder="Paciente" class="w-full">
                    <el-option v-for="item in pacientes.data" :key="item.id_paciente" :label="item.nombre_paciente" :value="item.id_paciente"></el-option>
                  </el-select>
                </label>
              </div>
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-input placeholder="Referencia del pago" type="text" v-model="datosVenta.referencia"></el-input>
                </label>
              </div>
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  <p class="ml-1">Iva</p>
                  <el-input placeholder="Iva de la venta" type="number" v-model="datosVenta.ivaVenta"></el-input>
                </label>
              </div>
              ...
              <div class="w-full md:w-1/2 lg:w-2/5 px-2 mb-3 py-1">
                <label>
                  ...
                  <el-input placeholder="Monto del Dolar Actual en Bs" type="number" min="1" step="any" v-model="datosVenta.precioDolar"></el-input>
                </label>
              </div>
